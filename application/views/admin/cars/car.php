    ...
    <div class="col-sm-12 fadeInUp wow" data-wow-delay="0.3s">
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
                <h3 class="panel-title"> تعديل نوع السيارة</h3>
            </div>
            <div class="panel-body">
                <div class="form-group col-sm-4">
                    <label class="label label-green  half">نوع السيارة</label>
                    <input type="text" class="form-control half input-style" name="name"  value="<?php echo $results['name'] ?>" required>
                </div>
            </div>
        </div>
    </div>
...
<?php else: ?>
    ...
    <div class="col-sm-12 fadeInUp wow" data-wow-delay="0.3s">
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
                <h3 class="panel-title"> أنواع السيارات</h3>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group col-sm-4">
                    <label class="label label-green  half"> نوع السيارة</label>
                    <input type="text" name="name"  readonly class="form-control half input-style" placeholder="نوع السيارة" >
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                            ...
                            <?php $a=1;foreach ($records as $record ):?>
                                <tr>
                                    ...
                                    <td> <a href="<?php echo base_url('dashboard/update_car').'/'.$record->id?>"><button type="button" class="btn btn-add btn-xs" data-toggle="modal" data-target="#update"><i class="fa fa-pencil"></i></button> </a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h1 class="modal-title">حذف نوع سيارة </h1>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?php echo base_url('dashboard/delete_car').'/'.$record->id ?>"><button type="button" class="btn btn-danger">حذف</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
