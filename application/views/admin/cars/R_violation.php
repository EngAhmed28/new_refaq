...
<div class="col-sm-12 fadeInUp wow" data-wow-delay="0.3s">
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        <div class="panel-heading">
            <h3 class="panel-title">تقرير المخالفات خلال فترة</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="form-group col-sm-4">
                ...
                <select class="choose-date selectpicker form-control half" name="car_id_fk" id="car_id_fk"  onchange="return loadd($('#date_from').val(),$('#date_to').val(),$('#car_id_fk').val());" required data-show-subtext="true" data-live-search="true" >
