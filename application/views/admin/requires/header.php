...
<!-- Mirrored from crm.thememinister.com/crmAdmin/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jun 2017 08:03:57 GMT -->
<head>
	<meta charset="utf-8">
	...
	<!-- Start Global Mandatory Style
        =====================================================================-->
	<!-- jquery-ui css -->
	<link href="<?php echo base_url()?>asisst/admin_asset/plugins/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet" type="text/css"/>
	<!-- Bootstrap -->
	...
	<!-- Lobipanel css -->
	<link href="<?php echo base_url()?>asisst/admin_asset/plugins/lobipanel/lobipanel.min.css" rel="stylesheet" type="text/css"/>
	<!-- Pace css -->
	<link href="<?php echo base_url()?>asisst/admin_asset/plugins/pace/flash.css" rel="stylesheet" type="text/css"/>
	<!-- Font Awesome -->
	<link href="<?php echo base_url()?>asisst/admin_asset/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
	<!-- Pe-icon -->
	...
	<!-- Start page Label Plugins
        =====================================================================-->
	<!-- Emojionearea -->
	<link href="<?php echo base_url()?>asisst/admin_asset/plugins/emojionearea/emojionearea.min.css" rel="stylesheet" type="text/css"/>
	<!-- Monthly css -->
	<link href="<?php echo base_url()?>asisst/admin_asset/plugins/monthly/monthly.css" rel="stylesheet" type="text/css"/>
	...
	<link href="<?php echo base_url()?>asisst/admin_asset/plugins/bootstrap-social/bootstrap-social.css" rel="stylesheet" type="text/css"/>
	<!-- End page Label Plugins
       =====================================================================-->
	...
	<link href="<?php echo base_url()?>asisst/admin_asset/plugins/modals/component.css" rel="stylesheet" type="text/css"/>
		...
		<a href="index-2.html" class="logo">
			<!-- Logo -->
     			<span class="logo-mini">
     				<img src="<?php echo base_url()?>asisst/admin_asset/img/mini-logo.png" alt="">
     			</span>
     			<span class="logo-lg">
     				<img src="<?php echo base_url()?>asisst/admin_asset/img/logo.png" alt="">
     			</span>
		</a>
		<!-- Header Navbar -->
								...
								<ul class="menu">
									<li >
										...
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/basketball-jersey.png" class="img-thumbnail" alt="User Image">
											</div>
											<h4>polo shirt</h4>
									...
									<li>
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/shirt.png" class="img-thumbnail" alt="User Image">
											</div>
											<h4>Kits</h4>
									...
									<li>
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/football.png" class="img-thumbnail" alt="User Image">
											</div>
											<h4>Football</h4>
									...
									<li class="nav-list">
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/shoe.png" class="img-thumbnail" alt="User Image">
											</div>
											<h4>Sports sheos</h4>
							...
							<li>
								<ul class="menu">
									<li>
										...
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/avatar.png" class="img-circle" alt="User Image">
											</div>
											<h4>Ronaldo</h4>
									...
									<li>
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/avatar2.png" class="img-circle" alt="User Image">
											</div>
											<h4>Leo messi</h4>
									...
									<li>
										<a href="#" class="border-gray">
											<div class="pull-left" >
												<img src="<?php echo base_url()?>asisst/admin_asset/img/avatar3.png" class="img-circle" alt="User Image">
											</div>
											<h4>Modric</h4>
									...
									<li>
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/avatar4.png" class="img-circle" alt="User Image">
											</div>
											<h4>Salman</h4>
									...
									<li>
										<a href="#" class="border-gray">
											<div class="pull-left">
												<img src="<?php echo base_url()?>asisst/admin_asset/img/avatar5.png" class="img-circle" alt="User Image">
											</div>
											<h4>Sergio Ramos</h4>
